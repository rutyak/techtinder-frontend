...
function FeedCards() {
  ...
  return (
    <>
      <SiTinder size={14} className="text-gray-100" />
      <div className="w-full h-full flex flex-col justify-center items-center lg:mt-10">
        <div className="relative w-[95%] h-full sm:w-[310px] sm:h-[420px]">
